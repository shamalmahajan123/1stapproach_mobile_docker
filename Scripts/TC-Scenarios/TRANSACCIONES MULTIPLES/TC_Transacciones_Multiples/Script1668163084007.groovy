...
WebUI.callTestCase(findTestCase('CommonTestCases/TC_ProfileVerification'), [('Verification') : Verification, ('Description') : Description,('CuentaOrigen') : CuentaOrigen,('CuentaDestino') : CuentaDestino,('CuentaDestino1') : CuentaDestino1,('CuentaDestino2') : CuentaDestino2,('CuentaDestino3') : CuentaDestino3,('CuentaDestino4') : CuentaDestino4,('CuentaDestino5') : CuentaDestino5,('CuentaDestino6') : CuentaDestino6, ('DestinoCount') : DestinoCount], FailureHandling.STOP_ON_FAILURE)
