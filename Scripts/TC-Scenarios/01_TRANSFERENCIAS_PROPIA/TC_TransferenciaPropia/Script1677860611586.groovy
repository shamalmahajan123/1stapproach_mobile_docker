...
//	if(Description.contains('Destination Account Restricted')) {
...
//			
//			if(GlobalVariable.OrigenAccountStatus != 'NotAvailable' && GlobalVariable.DestinoAccountStatus != 'NotAvailable') {
//				CustomKeywords.'helper.customfunction.Screenshot'()
//			}
//		}	
	}
