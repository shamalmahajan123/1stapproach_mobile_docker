...
def Email() {
    ...
    if (Mobile.waitForElementPresent(findTestObject('Login/Registro de dispositivo'), 20, FailureHandling.STOP_ON_FAILURE)) {
        ...
        Mobile.tap(findTestObject('Buttons/ACEPTAR'), 15, FailureHandling.OPTIONAL)
    ...
    Mobile.setText(findTestObject('Login/Email-Codigo'), Email, 5, FailureHandling.OPTIONAL)
